...
// and '"New York"'. Access the third element in the array and store it in a variable named 'favoriteCity'.

let cities = ["London", "Tokyo", "Paris" , "New York"];
const favoriteCity = cities[2];


// 3. You have an array named 'TeaTypes' containing '"herbal tea"' , '"White tea"' ,'"masala tea"' . Change the second element of the array to '"jasmine tea"' .
